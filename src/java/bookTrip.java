...
public class bookTrip extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            System.out.println(tripNum+"    "+userID+"   "+price+"  "+charge);
            
            booking.book(tNum, userID, seats, charge);
            
            AllTrips.updateSeats(tNum, seats);
            
            RequestDispatcher rd = request.getRequestDispatcher("allTrips.jsp");
